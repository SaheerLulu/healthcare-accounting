"""Add SERVICE_INCOME to AccountMapping.KEY_CHOICES (choices-only, no DDL)."""
# Generated by Django 6.0.2 on 2026-07-29 09:06
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0028_service_income_mapping'),
    ]
