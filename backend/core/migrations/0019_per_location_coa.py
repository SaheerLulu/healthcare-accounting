# Generated by Django 6.0.2 on 2026-05-25 09:29
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddConstraint(
            model_name='accountmapping',
            constraint=models.UniqueConstraint(fields=('key', 'location_id'), name='unique_mapping_per_location', nulls_distinct=False),
        ),
        migrations.AddConstraint(
            model_name='chartofaccount',
            constraint=models.UniqueConstraint(fields=('account_code', 'location_id'), name='unique_account_code_per_location', nulls_distinct=False),
        ),
    ]
