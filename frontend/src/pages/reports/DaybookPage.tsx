...
export default function DaybookPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-5">
      <div className="mb-6">
        <h1 className="text-xl font-semibold" style={{ color: "var(--ink)", letterSpacing: "-0.01em" }}>Daybook</h1>
        <p className="text-sm mt-0.5" style={{ color: "var(--ink-2)" }}>Chronological register of all transactions</p>
      </div>
